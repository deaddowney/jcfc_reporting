...
import coop.jcfoodcoop.reporting.*
 ...
 * @author akrieg
 */
class LancasterParser {

    private final File outputFile
    private final File inputFile

    public LancasterParser(File inputFile, File outputFile) {
    ...
    public void parse() {
        ...
        KnowledgeBase kb = KnowledgeBaseFactory.parseCsv(new InputStreamReader(this.getClass().getResourceAsStream("/knowledgeBase.csv")))
