...
// call onCancel() on ESCAPE
        ...
        findFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                int returnVal = chooser.showOpenDialog(SupplierForm.this);
    ...
    private void onOK() {
        ...
        SwingWorker<?, ?> worker = new SwingWorker<Object, Object>() {
            ...
            protected void done() {
                try {
                    get();
                    JOptionPane.showMessageDialog(SupplierForm.this, "Successfully created output file :" + outFile);
                    Desktop.getDesktop().edit(outFile);
                } catch (Exception e) {
                    e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
                    JOptionPane.showMessageDialog(SupplierForm.this, "Error created output file :" + e.getMessage());
